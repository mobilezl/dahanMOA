...
function onSub(ContactsName,Title){
	 ...
	 var url =UrlRoot+"ContactsService.ashx?Action=SaveFrequentContacts&userID="+UserInfo.UserId+"&accesc_Token="
	+UserInfo.accesc_Token
	+"&openId="
	+UserInfo.openId+"&ContactsId="+userCode.UserID+"&ContactsName="+ContactsName+"&ContactsTitle="+Title;
