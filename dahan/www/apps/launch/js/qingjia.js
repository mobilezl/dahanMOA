...
function getUserInfoCallback(Info){
	UserInfo =eval("(" + Info + ")");
	var url = UrlRoot+"LeaveProxyService.ashx?Action=GetLeaveInfo&userID="
	+ UserInfo.UserId
	+"&accesc_Token="
...
function onSub(){
	...
	var url =UrlRoot+"LeaveProxyService.ashx?Action=SaveDrafInfo&userID="
	+ UserInfo.UserId
	+"&accesc_Token="
	+UserInfo.accesc_Token
	+"&openId="
	+UserInfo.openId
	+ "&detailEntityJson="+escape(detailEntityJson)+"&basicEntityJson="+(basicEntityJson)+"&flag="+flag+"&processCode=" + escape(processCode);
